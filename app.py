...
EXCEL_PATH = Path(r"C:/Users/birkm/OneDrive - hochschule-stralsund.de/Desktop/Normen/data/Birkmann-Tabellarische_Darstellung_Kategorien_250714_SM.xlsx")
DATA_CANDIDATES = [
    Path("data") / "Birkmann-Tabellarische_Darstellung_Kategorien_250714_SM.xlsx",
    Path("Birkmann-Tabellarische_Darstellung_Kategorien_250714_SM.xlsx"),
]
